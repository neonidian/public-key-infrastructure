...
# Generating a key pair. SAN or subject alternative mentioned below should have IP or DNS of machines that host the servers which may want to communicate with each other
